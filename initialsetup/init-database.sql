...
CREATE TABLE order_items (
    ...
    return_status VARCHAR(50) CHECK (return_status IS NULL OR return_status IN ('none', 'partial', 'full')),
...
-- ============================================================
-- Returns Table (Individual Item Returns)
-- ============================================================
...
-- Return refunds updated_at trigger
